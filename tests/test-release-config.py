...
assert version['webRevision'] == 4
assert version['versionName'] == '2.3.1'
assert 'web-adapter-v231.js?v=2.3.1-r4' in index
...
assert 'git("config", "core.fileMode", "false")' in updater
print('PASS: CSP same-origin, revision metadata, and Git mode handling')
