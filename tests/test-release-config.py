...
assert version['versionName'] == '2.3.9'
assert version['versionCode'] == 37
assert 'hardening-v232.js?v=2.3.9-r1' in index
assert 'web-adapter-v232.js?v=2.3.9-r1' in index
...
assert 'report-period-v234.js?v=2.3.9-r1' in index
assert 'report-period-v234.css?v=2.3.9-r1' in index
print('PASS: v2.3.9 web revision 1 metadata, A4 preview, realtime periods, CSP, responsive layer, and updater hardening')
