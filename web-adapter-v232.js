    ...
    window.infoContent = function (kind) {
        ...
        if (kind === 'about') {
            return '<div class="version-box"><img src="logo-mark.png"><h2>FinUp Web</h2><p>Atur uang, raih tujuan.</p><span class="badge badge-green">Versi ' + APP_VERSION + '</span><p>Version Code ' + VERSION_CODE + '</p></div>'
                ...
                + '<h3>Penyempurnaan Web v2.3.9 Revision 1</h3><ul><li>Header utama tetap terlihat saat Dashboard dan modul digulir.</li><li>Header halaman fitur tetap menempel pada bagian atas kontainer.</li><li>Tinggi header menyesuaikan mobile, tablet, desktop, portrait, landscape, dan safe area.</li><li>Perbaikan laporan, konflik sinkronisasi, keamanan sesi, dan updater admin tetap dipertahankan.</li></ul>'
